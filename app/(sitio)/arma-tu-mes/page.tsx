...
export default async function ArmaTuMesPage({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <FlowNav />
      <Stepper activo={4} />
      <main className="flex flex-col items-start gap-[30px] px-[100px] pb-10 pt-[52px]">
        <div className="flex w-full items-center justify-between">
          <div className="flex flex-col gap-[10px]">
            <h1 className="text-display-m text-cream">Arma tu mes</h1>
            <p className="w-[620px] text-[16px] leading-[26px] text-muted">
        ...
        <div className="flex w-full flex-col gap-[14px] rounded-card border border-line bg-surface px-6 py-[22px]">
          ...
          <div className="flex w-full gap-3">
            {["LUN", "MAR", "MIÉ", "JUE", "VIE"].map((h, i) => {
              ...
              return (
                <div key={h} className="flex flex-1 flex-col gap-1.5 rounded-control border border-line bg-ink px-3.5 py-3">
      ...
      <div className="flex w-full items-center justify-between border-t border-line bg-surface px-[100px] py-6">
        <div className="flex flex-col gap-2">
          <p className="text-[18px] font-medium text-cream">
            {asignadosEsteMes} de {totalCreditos} créditos asignados&nbsp;&nbsp;·&nbsp;&nbsp;{saldo} sin usar
          </p>
          <div className="h-[6px] w-[300px] overflow-hidden rounded-pill bg-line">
            <div
