...
export default async function CrearCuentaPage({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <FlowNav />
      <Stepper activo={2} />
      <main className="flex flex-col gap-14 px-6 pb-16 pt-10 md:px-10 lg:flex-row lg:px-[100px] lg:pb-[90px] lg:pt-[60px]">
        <CrearCuentaForm paqueteId={paquete?.id ?? ""} />
        <aside className="w-full rounded-card-lg border border-line bg-surface p-7 lg:w-[380px] lg:shrink-0 order-first lg:order-last">
