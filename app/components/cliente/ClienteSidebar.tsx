...
const LINKS = [
  ...
  { href: "/arma-tu-mes", label: "Mi calendario", exact: false },
 ...
 * "Mi calendario" reutiliza /arma-tu-mes (misma pantalla que en el
 * flujo de compra 04, ya protegida con requireUsuario).
 */
