 ...
 * semana) para no meter lógica de fechas en el cliente. Compartido
 * entre el flujo de compra (`/arma-tu-mes`) y el panel de cliente
 * (`/cuenta/calendario`).
 */
    ...
    <div className="w-full overflow-x-auto">
      <div className="flex w-full min-w-[700px] flex-col gap-3">
        ...
        <div className="flex flex-wrap items-center gap-x-[26px] gap-y-2 pt-2">
          ...
          <Leyenda color="border border-dashed border-line/70 bg-transparent" label="Menú por confirmar" />
