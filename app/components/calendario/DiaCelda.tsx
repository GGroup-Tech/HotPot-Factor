    ...
    <div className="relative">
      ...
      >
        ...
        {nombreMostrado ? (
          ...
          <p className="text-[12px] italic leading-[19px] text-muted/70">Menú por confirmar</p>
        ) : (
          <p className="text-[13px] leading-[19px] text-disabled">—</p>
        )}
        {dia.editable && asignado && <p className="text-[12px] font-medium text-gold">1 crédito</p>}
        {dia.pedido?.esComodin && <span className="badge">COMODÍN</span>}
        {!dia.editable && (
