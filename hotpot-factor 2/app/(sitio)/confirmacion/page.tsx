...
export default async function ConfirmacionPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div className="flex items-center justify-between px-6 md:px-10 lg:px-[100px] py-6">
      ...
      <main className="flex flex-col items-center gap-[26px] px-6 md:px-10 lg:px-[100px] pb-[130px] pt-[110px]">
        ...
        <p className="w-full max-w-[520px] text-center text-[17px] leading-7 text-muted">
          Te mandamos el detalle a tu correo. Recibirás un recordatorio 48 horas antes de cada entrega.
        </p>

        <div className="flex w-full max-w-[560px] flex-col rounded-card-lg border border-line bg-surface px-8">
